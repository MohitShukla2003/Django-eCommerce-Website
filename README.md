...
![Homepage Screenshot](<Screenshot (53).png>)

### Wishlist Page

![Wishlist Screenshot](<Screenshot (54).png>)

### Order History Page

![Order-History Screenshot](<Screenshot (55).png>)


### Contact-Us Page

![Contact-Us Screenshot](<Screenshot (57).png>)

### About-Us Page

![About-Us Screenshot](<Screenshot (58).png>)


### Shopping Cart Page

![Cart Page Screenshot](<Screenshot (59).png>)
...
![Profile Page Screenshot](<Screenshot (60).png>)

### Shipping Address Page

![Shipping Address Page Screenshot](<Screenshot (61).png>)
...
1. **Clone the repository:**
   ...
   ```bash
   git clone https://github.com/MohitShukla2003/Django-eCommerce-Website.git
...
- Open your terminal (make sure your virtual environment is activated, it should be something like this - `(venv) PS C:\Users\Mohit\Django-eCommerce-Website`)
